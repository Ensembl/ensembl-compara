...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "anolis_carolinensis" AND assembly = "AnoCar2.0";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "astyanax_mexicanus" AND assembly = "Astyanax_mexicanus-2.0";
UPDATE genome_db SET is_good_for_alignment = 1 WHERE name = "bos_taurus" AND assembly = "UMD3.1";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "cavia_aperea" AND assembly = "CavAp1.0";
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "cavia_porcellus" AND assembly = "Cavpor3.0";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "ciona_intestinalis" AND assembly = "KH";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "danio_rerio" AND assembly = "GRCz11";
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "dasypus_novemcinctus" AND assembly = "Dasnov3.0";
UPDATE genome_db SET is_good_for_alignment = 1 WHERE name = "dipodomys_ordii" AND assembly = "Dord_2.0";
...
UPDATE genome_db SET is_good_for_alignment = 1 WHERE name = "equus_caballus" AND assembly = "EquCab2";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "gambusia_affinis" AND assembly = "ASM309773v1";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "homo_sapiens" AND assembly = "GRCh38";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "loxodonta_africana" AND assembly = "loxAfr3";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "maylandia_zebra" AND assembly = "M_zebra_UMD2a";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "mola_mola" AND assembly = "ASM169857v1";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "mus_musculus" AND assembly = "GRCm38";
...
UPDATE genome_db SET is_good_for_alignment = 1 WHERE name = "ornithorhynchus_anatinus" AND assembly = "OANA5";
...
UPDATE genome_db SET is_good_for_alignment = 1 WHERE name = "pygocentrus_nattereri" AND assembly = "Pygocentrus_nattereri-1.0.2";
...
UPDATE genome_db SET is_good_for_alignment = 0 WHERE name = "takifugu_rubripes" AND assembly = "FUGU5";
