...
ALTER TABLE homology
  ...
  ADD FOREIGN KEY (species_tree_node_id) REFERENCES species_tree_node(node_id),
  ADD FOREIGN KEY (gene_tree_node_id) REFERENCES gene_tree_node(node_id),
  ADD FOREIGN KEY (gene_tree_root_id) REFERENCES gene_tree_root(root_id);
