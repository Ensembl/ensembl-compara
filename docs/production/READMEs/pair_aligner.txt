...
2- Necessary software components
   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Compiled binaries:
  lastz => /software/ensembl/compara/bin/lastz (Set in Lastz_conf.pm or Lastz_primate_conf.pm)
  blat => /software/ensembl/compara/bin/blat (Set in TBlat_conf.pm)
...
in tcsh
    ...
    setenv PERL5LIB  ${ENSEMBL_CVS_ROOT_DIR}/ensembl/modules:${ENSEMBL_CVS_ROOT_DIR}/bioperl-live:${ENSEMBL_CVS_ROOT_DIR}/ensembl-compara/modules:${ENSEMBL_CVS_ROOT_DIR}/ensembl-hive/modules:${ENSEMBL_CVS_ROOT_DIR}/ensembl-analysis/modules
...
in bash
    ...
    PERL5LIB=${ENSEMBL_CVS_ROOT_DIR}/ensembl/modules:${ENSEMBL_CVS_ROOT_DIR}/bioperl-live:${ENSEMBL_CVS_ROOT_DIR}/ensembl-compara/modules:${ENSEMBL_CVS_ROOT_DIR}/ensembl-hive/modules:${ENSEMBL_CVS_ROOT_DIR}/ensembl-hive/modules
...
3.3- Using the pairwise alignment configuration file.
...
To run the pipeline with a master database (recommended) it is necessary to create the master if it does not already exist (see README-master_database for details on how to create an initial master database) and to update it with the new species and method_link_species_set.

4.1- Update genome_db and dnafrag tables with any new species assembly using the update_genome.pl script
eg
...
4.2- Update method_link_species_set table with new method_link_species_set entry
...
5- Run init_pipeline.pl
   ~~~~~~~~~~~~~~~~~~~~
It is possible to set the parameters defined in default_options directly on the command line. You over-ride simple "scalar" parameters by adding "-" to the front eg -mlss_id or -dbname as in the examples below. If you need to modify second-level values of a "hash option" (such as the '-user' or '-host' of the 'pipeline_db' option), the syntax follows the extended syntax of Getopt::Long, eg -pipeline_db -host=myhost -pipeline_db -user=readonly
...
6- Run the beekeeper
   ~~~~~~~~~~~~~~~~~
Details on how to run the beekeeper are given in the README-beekeeper document.


7- Healthchecks and Statistics
   ~~~~~~~~~~~~~~~~~~~~~~~~~~~
