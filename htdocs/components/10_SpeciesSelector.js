...
Ensembl.Panel.SpeciesSelector = Ensembl.Panel.extend({
  ...
  init: function () {
    ...
    this.elLk.speciesList = $('.species_list', this.elLk.content);
    
    var ul = $('ul', this.elLk.speciesList);
    var spans = $('span', ul)
  ...
  style: function () {
    ...
    this.elLk.speciesList.width('');
    this.elLk.speciesList.width(this.elLk.speciesList.width() < width + this.buttonWidth ? '100%' : '');
  },
