...
Ensembl.Panel.Overlay = Ensembl.Panel.extend({
  constructor: function (id) {
    ...
    this.constant   = { isOldIE: $(document.body).hasClass('ie67'), minWidth: 800, minHeight: 600, padding: 100, minPad: 25, borderWidth: 7, zIndex: 999999999, titleHeight: 20, minCustomWidth: 700, minCustomHeight: 400, keepAspect: false };
  ...
  getMaxDimensions: function() {
    return {
      w: this.windowWidth  - this.constant.borderWidth * 2 - 22, //22 corresponds to the dimensions to the close button image
      h: this.windowHeight - this.constant.borderWidth * 2 - 22
    }
  },
