...
DynaTreeNode.prototype = {
  ...
  toString: function() {
    return "DynaTreeNode<" + this.data.key + ">: '" + this.data.synonym || this.data.synonym + "'";
  },
...
//      noop(); // keep JSLint happy
    ...
    if(!nodeTitle){
      ...
      if( opts.noLink || data.noLink ) {
        nodeTitle =  '<span style="display:inline-block;" class="' + opts.classNames.title + ' ' + strain_class + '"' + tooltip + '>' + data.title + '</span>';
//        this.tree.logDebug("nodeTitle: " + nodeTitle);
      } else {
        nodeTitle = '<a href="' + href + '" class="' + opts.classNames.title + ' ' + strain_class + '"' + tooltip + '>' + data.title + '</a>';
      }
    }
    res += nodeTitle;
    return res;
