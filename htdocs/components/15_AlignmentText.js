...
Ensembl.Panel.AlignmentText = Ensembl.Panel.Content.extend({
  ...
  init: function () {
    ...
    var message_text_full = 'Currently showing full alignment. Please click the button below to hide.'
    ...
    $('div.display_full_message_div a', panel.el).on('click', function(e) {
      ...
      if ($(this).html() === 'Display full alignment') {
        ...
        partial_alignment_panel && partial_alignment_panel.el.fadeOut();
