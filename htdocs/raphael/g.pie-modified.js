 ...
 *
 * Modified locally by L.Gil (23/05/2011)
 *
 */
Raphael.fn.g.piechart = function (cx, cy, r, values, opts) {
    ...
    if (len == 1) {
        ...
        for (i = 0; i < len; i++) {
            ...
            if (!i) {
								// The following line has been modified to start the first sector at "midday".
                angle = (360 * values[i] / total / 2)+((360 * values[i] / total / 2)-270); //angle = 90 - mangle;
