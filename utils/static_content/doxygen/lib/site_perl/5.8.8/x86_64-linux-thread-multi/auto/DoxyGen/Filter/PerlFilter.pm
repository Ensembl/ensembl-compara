...
#
#
# State Machine rewrite of existing filter. Flow was horrid to follow. 
# Was going to use DFA::Command to handle the logic, but actually it won't work well for parsing Perl, hence own simplified state machine.
# 
# This code is still highly volatile and needs refactoring. 
...
use warnings;
use strict;
#use feature "switch"; # play with 5.10 toy!
use Switch 'Perl6'; #older switch version
...
sub filter {
    ...
    # beware of printing of #include coming from elsewhere (&inheritance_action).
