...
# Just run the make_html_docs.sh script, and the Pdocs will be generated in the
# PDOC_LOC directory.  You have to mkdir each of the Fnumber directories in this# directory first: e.g. mkdir PDOC_LOC/bioperl-live, etc.
#
# jws 2002-01-08
#
...
PDOC_LOC="/ensemblweb/www/server/htdocs/info/software/Pdoc"    # where you want Pdocs created
