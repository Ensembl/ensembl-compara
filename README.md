...
[![Build Status](https://travis-ci.org/Ensembl/ensembl-compara.svg?branch=release/112)](https://travis-ci.org/Ensembl/ensembl-compara)
[![Codecov Status](https://codecov.io/gh/ensembl/ensembl-compara/branch/release/112/graph/badge.svg)](https://codecov.io/github/Ensembl/ensembl-compara)
...
See [the main Ensembl repository](https://github.com/Ensembl/ensembl/blob/release/112/CONTRIBUTING.md)
...
dependencies](https://github.com/Ensembl/ensembl/blob/release/112/cpanfile) and
[ours](cpanfile).
