...
[![Build Status](https://travis-ci.org/Ensembl/ensembl-compara.svg?branch=release/101)](https://travis-ci.org/Ensembl/ensembl-compara)
[![Coverage Status](https://coveralls.io/repos/Ensembl/ensembl-compara/badge.svg?branch=release/101&service=github)](https://coveralls.io/github/Ensembl/ensembl-compara?branch=release/101)
...
See [the main Ensembl repository](https://github.com/Ensembl/ensembl/blob/release/101/CONTRIBUTING.md)
...
dependencies](https://github.com/Ensembl/ensembl/blob/release/101/cpanfile) and
[ours](cpanfile).
