...
[![Build Status](https://travis-ci.org/Ensembl/ensembl-compara.svg?branch=release/106)](https://travis-ci.org/Ensembl/ensembl-compara)
[![Codecov Status](https://codecov.io/gh/ensembl/ensembl-compara/branch/release/106/graph/badge.svg)](https://codecov.io/github/Ensembl/ensembl-compara?branch=release/106)
...
See [the main Ensembl repository](https://github.com/Ensembl/ensembl/blob/release/106/CONTRIBUTING.md)
...
dependencies](https://github.com/Ensembl/ensembl/blob/release/106/cpanfile) and
[ours](cpanfile).
