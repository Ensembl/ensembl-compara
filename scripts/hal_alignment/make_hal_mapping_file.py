...
"""Utility script to make HAL mapping TSV file."""
...
def main() -> None:
    ...
    parser.add_argument("-o", "--output-tsv", help="Output HAL mapping TSV file.")
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        with open(args.output_tsv, mode="w", encoding="utf-8", newline="") as out_file_obj:
            ...
            for hal_seq_id, meta_seq_id in sorted(seq_id_map.items()):
                writer.writerow([args.hal_genome, assembly_uuid, hal_seq_id, meta_seq_id])
