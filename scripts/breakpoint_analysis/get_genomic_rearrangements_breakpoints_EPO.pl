...
=head1 DESCRIPTION
 ...
 To run this script, you need to give it the following
    ...
    example run : perl get_genomic_rearrangements_breakpoints_EPO.pl -species1 mus_caroli -species2 mus_pahari -kb 10 -output trial_b -reg_conf /nfs/users/nfs_w/wa2/Mouse_rearrangement_project/mouse_reg_livemirror.conf
