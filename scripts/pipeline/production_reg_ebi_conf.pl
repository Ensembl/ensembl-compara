...
Bio::EnsEMBL::Compara::DBSQL::DBAdaptor->new(
     ...
     -dbname => 'muffato_protein_trees_91',
);
...
Bio::EnsEMBL::Compara::DBSQL::DBAdaptor->new(
    ...
    -dbname => 'waakanni_murinae_protein_trees_91',
);
...
Bio::EnsEMBL::Compara::DBSQL::DBAdaptor->new(
     ...
     -port => 4523,
     -species => 'mammals_epo',
     -dbname => 'waakanni_mammals_epo_91',
);
...
Bio::EnsEMBL::Compara::DBSQL::DBAdaptor->new(
     ...
     -dbname => 'mateus_epo_low_mammals_91',
);
