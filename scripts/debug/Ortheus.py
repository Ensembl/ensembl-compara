...
subprocess.check_call(['cp', os.path.join(ref_fasta_dir, f'output.{pid}.mfa'), output_alignment_path])
...
with open(os.path.join(ref_fasta_dir, f'output.{pid}.tree'), 'r') as fh:
    tl = fh.readlines()
