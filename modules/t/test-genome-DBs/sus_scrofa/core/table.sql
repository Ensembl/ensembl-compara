...
) ENGINE=MyISAM AUTO_INCREMENT=4482622 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=24666119 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=197676 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=25010 DEFAULT CHARSET=latin1;
...
CREATE TABLE `marker_feature` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`),
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=22314 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=24975 DEFAULT CHARSET=latin1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1000745 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=13169 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_exon` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`)
) ENGINE=MyISAM AUTO_INCREMENT=362922 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_transcript` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`),
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=52373 DEFAULT CHARSET=latin1;
...
CREATE TABLE `protein_align_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `external_db_idx` (`external_db_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8331702 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
CREATE TABLE `protein_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=279344 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=368506 DEFAULT CHARSET=latin1;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8552859 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=196588 DEFAULT CHARSET=latin1;
...
CREATE TABLE `seq_region_synonym` (
  ...
  KEY `seq_region_idx` (`seq_region_id`)
) ENGINE=MyISAM AUTO_INCREMENT=175700 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=217591 DEFAULT CHARSET=latin1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=23119 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=666376 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=2326083 DEFAULT CHARSET=latin1;
