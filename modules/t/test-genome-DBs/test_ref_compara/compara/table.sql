...
) ENGINE=MyISAM AUTO_INCREMENT=55 DEFAULT CHARSET=latin1 MAX_ROWS=100000000;
...
CREATE TABLE `sequence` (
  ...
  KEY `md5sum` (`md5sum`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 MAX_ROWS=10000000 AVG_ROW_LENGTH=19000;
