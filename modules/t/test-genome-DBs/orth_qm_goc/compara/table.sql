...
) ENGINE=MyISAM AUTO_INCREMENT=14026798 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=9122580 DEFAULT CHARSET=latin1;
...
CREATE TABLE `homology` (
  ...
  KEY `gene_tree_root_id` (`gene_tree_root_id`)
) ENGINE=MyISAM AUTO_INCREMENT=46121 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=100022 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=9330112 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=36127 DEFAULT CHARSET=latin1;
