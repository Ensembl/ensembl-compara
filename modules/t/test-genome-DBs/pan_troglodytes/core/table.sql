...
) ENGINE=MyISAM AUTO_INCREMENT=12805063 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=23207771 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=826577 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=101167 DEFAULT CHARSET=latin1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=832124 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=65328 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_exon` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`)
) ENGINE=MyISAM AUTO_INCREMENT=328963 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_transcript` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`),
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=56688 DEFAULT CHARSET=latin1;
...
CREATE TABLE `protein_align_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `external_db_idx` (`external_db_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8357392 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
CREATE TABLE `protein_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=266758 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=561371 DEFAULT CHARSET=latin1;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=13620554 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=212412 DEFAULT CHARSET=latin1;
...
CREATE TABLE `seq_region_synonym` (
  ...
  KEY `seq_region_idx` (`seq_region_id`)
) ENGINE=MyISAM AUTO_INCREMENT=511274 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transcript` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=102315 DEFAULT CHARSET=latin1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=93086 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=810944 DEFAULT CHARSET=latin1;
