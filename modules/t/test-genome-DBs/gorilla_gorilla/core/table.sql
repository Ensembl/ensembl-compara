...
) ENGINE=MyISAM AUTO_INCREMENT=5884885 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=25066745 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=474020 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=58135 DEFAULT CHARSET=latin1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1446083 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=16053 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_exon` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`)
) ENGINE=MyISAM AUTO_INCREMENT=326136 DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction_transcript` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`),
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=50832 DEFAULT CHARSET=latin1;
...
CREATE TABLE `protein_align_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `external_db_idx` (`external_db_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6835181 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
CREATE TABLE `protein_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=787257 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=524647 DEFAULT CHARSET=latin1;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8781253 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=574125 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=149660 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transcript` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=71154 DEFAULT CHARSET=latin1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=54922 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=53685 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=904548 DEFAULT CHARSET=latin1;
