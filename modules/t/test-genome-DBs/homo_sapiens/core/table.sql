...
) ENGINE=MyISAM AUTO_INCREMENT=3585 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=4288308 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=367810 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=1813 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=504069 DEFAULT CHARSET=latin1;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=30041743 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=1000859480 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transcript` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=1174828 DEFAULT CHARSET=latin1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=541895 DEFAULT CHARSET=latin1;
