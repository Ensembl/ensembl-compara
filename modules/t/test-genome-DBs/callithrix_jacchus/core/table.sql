...
) ENGINE=MyISAM AUTO_INCREMENT=460852 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=43923 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=484155 DEFAULT CHARSET=latin1;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6263638 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=209309 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transcript` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=77473 DEFAULT CHARSET=latin1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=33228 DEFAULT CHARSET=latin1;
