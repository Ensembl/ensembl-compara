...
sub new {
  ...
  warn "########### Module $class is deprecated and will be removed in release 82. Please update your code to use EnsEMBL::Draw::Renderer::$module instead";
...
sub render_Composite {
  ...
  for my $subglyph (@{$glyph->{'composite'}}) {
    ...
    if ($self->can($method)) {
      ...
      print STDERR "Sanger::Graphics::Renderer::render_Composite: Do not know how to $method\n";
    }
