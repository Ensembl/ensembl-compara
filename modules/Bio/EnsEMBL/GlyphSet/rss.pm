...
Bio::EnsEMBL::GlyphSet::rss.pm
GlyphSet to draw rss features

=head1 DESCRIPTION

Displays RSS simple features.
...
package Bio::EnsEMBL::GlyphSet::rss;
use strict;
use vars qw(@ISA);
...
=head2 features
  ...
  Return type : listref of RSS simple features
  Exceptions  : none
  Caller      : $self->_init()
...
=head2 zmenu
  ...
  Arg[1]      : feature ID
  Arg[2]      : a listref of RSS simple features
