package Bio::EnsEMBL::GlyphSet::decoration;
use strict;
use vars qw(@ISA);
use lib "..";
...
#    print STDERR qq(Bio::EnsEMBL::GlyphSet::Decoration::_init\n);
#    print STDERR qq(Bio::EnsEMBL::GlyphSet::Decoration::length = ), $this->length(), "\n";
