...
sub _init {
    ...
    my $max_length     = $Config->get( 'repeat_trna_lite', 'threshold' ) || 2000;
    my $navigation     = $Config->get( 'repeat_trna_lite', 'navigation' ) || 'off';
    my $max_length_nav = $Config->get( 'repeat_trna_lite', 'navigation_threshold' ) || 1500;
    my $feature_colour = $Config->get( 'repeat_trna_lite', 'col' );
