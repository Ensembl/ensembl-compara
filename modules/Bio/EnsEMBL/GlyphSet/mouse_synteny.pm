package Bio::EnsEMBL::GlyphSet::mouse_synteny;
use strict;
use vars qw(@ISA);
use Bio::EnsEMBL::GlyphSet_simple;
@ISA = qw(Bio::EnsEMBL::GlyphSet_simple);

sub my_label { return "Mouse synteny"; }

sub features {
    my ($self) = @_;
    return $self->{'container'}->get_all_compara_Syntenies( 'Mus musculus' );
}
...
sub href {
    ...
    my $en = $st + 1e6;
    return "/Mus_musculus/$ENV{'ENSEMBL_SCRIPT'}?l=".$f->{'hit_chr_name'}.":$st-$en";
}
