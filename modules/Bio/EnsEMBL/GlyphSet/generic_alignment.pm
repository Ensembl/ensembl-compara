...
@Bio::EnsEMBL::GlyphSet::generic_alignment::ISA = qw(Bio::EnsEMBL::GlyphSet_feature2);
...
sub unbumped_zmenu {
  ...
  return { 
    ...
    'Alignment' => sprintf( "/%s/alignview?class=DnaDnaAlignFeature&l=%s&s1=%s&l1=%s&type=%s", $first_species, $text2, $second_species, $text, $type ),
    "Jump to $species_2" => $self->href( $chr_pos ), 
    $ori => '' };
}
