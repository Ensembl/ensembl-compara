...
sub default_options {
    ...
    return {
        ...
        'threshold_levels' => [
            {
		'taxa'          => [ 'Aculeata', 'Anophelinae', 'Drosophila', 'Glossinidae', 'Ditrysia', 'Tephritidae', 'Aphidomorpha', 'Bemisia', 'Culicinae', 'Acrididae' ],
                'thresholds'    => [ 50, 50, 25 ],
            },
            {
                'taxa'          => [ 'Brachycera', 'Phlebotominae', 'Hymenoptera', 'Orthoptera', 'Trichoptera' ],
                'thresholds'    => [ 25, 25, 25 ],
            },
            {
                'taxa'          => [ 'Diptera', 'Hemiptera' ],
