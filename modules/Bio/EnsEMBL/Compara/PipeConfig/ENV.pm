...
sub executable_locations {
    ...
    return {
        ...
        'compare_enredo_regions_exe'        => $self->check_exe_in_ensembl('ensembl-compara/scripts/production/compare_enredo_regions.py'),
        ...
        'reheader_homology_tsv_exe'         => $self->check_exe_in_ensembl('ensembl-compara/scripts/pipeline/reheader_homology_tsv.py'),
        'split_homology_tsv_exe'            => $self->check_exe_in_ensembl('ensembl-compara/scripts/pipeline/split_homology_tsv.py'),
