...
=head1 NAME
  ...
  Bio::EnsEMBL::Compara::PipeConfig::CKProteinTrees_conf
...
=head1 SYNOPSIS
    ...
    #4. Run init_pipeline.pl script:
        init_pipeline.pl Bio::EnsEMBL::Compara::PipeConfig::CKProteinTrees_conf -password <your_password> -mlss_id <your_current_PT_mlss_id>
...
package Bio::EnsEMBL::Compara::PipeConfig::CKProteinTrees_conf;
...
#        'mlss_id'               => 90149,   # Metazoa it is very important to check that this value is current (commented out to make it obligatory to specify)
#        'mlss_id'               => 90938,   # Fungi it is very important to check that this value is current (commented out to make it obligatory to specify)
        'mlss_id'               => 89130,   # Plant it is very important to check that this value is current (commented out to make it obligatory to specify)
        'release'               => '73',
        'rel_suffix'            => 'Panther8_1HmmPlants_20_73_SF',    # an empty string by default, a letter otherwise
		'base_dir'              =>  '/nfs/nobackup2/ensemblgenomes/ckong/workspace/'.$self->o('ENV', 'USER').'/hive',
    	'work_dir'              =>  $self->o('base_dir').'/'.$self->o('mlss_id').'/protein_trees_'.$self->o('rel_with_suffix'),
    ...
    # blast parameters:
        ...
        'blast_tmp_dir'             => $self->o('work_dir') . '/blastTmp',  # if empty, will use Blast Analysis' default
...
#	    'mafft_binaries'  =>  $self->o('exe_dir').'/mafft-distro/bin/mafft',
 ...
 #   	'blast_path'      => '/nfs/panda/ensemblgenomes/external/ncbi-blast-2.2.23+-x86_64-Linux/bin',
    ...
    # HMM specific parameters (set to 0 or undef if not in use)
        ...
        'cm_file_or_directory' => '/nfs/nobackup2/ensemblgenomes/ckong/workspace/buildhmmprofiles/PLANTS_HMM2_EG20_8_1_SF/hmmLib', ## NEW HMMER DB
        'hmm_library_basedir'  => '/nfs/nobackup2/ensemblgenomes/ckong/workspace/buildhmmprofiles/PLANTS_HMM2_EG20_8_1_SF/hmmLib',
...
#        'master_db' => undef,
       ...
       'prev_rel_db' 				 	=> {   # usually previous release database on compara1
				...
				-user => 'ensrw',
		    	-pass => 'writ3r',
            	-dbname => 'ensembl_compara_plants_19_72',
        },
