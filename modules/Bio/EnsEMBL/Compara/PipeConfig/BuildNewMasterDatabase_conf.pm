...
=head1 SYNOPSIS
    ...
    init_pipeline.pl Bio::EnsEMBL::Compara::PipeConfig::BuildNewMasterDatabase_conf -input <path_to_regions_file(s)> -host <host_master_db> -port <host_port> -division <division>
...
sub default_options {
    ...
    return {
        ...
        'dst_host'      => $self->o('host'),
        'dst_port'      => $self->o('port'),
...
sub pipeline_analyses {
    ...
    return [
        ...
        {   -logic_name => 'clone_core_regions',
            ...
            -analysis_capacity => 1,
            -rc_name   => '500Mb_job',
            -flow_into => [ '?accu_name=cloned_dbs&accu_address={key_name}' ]
        },
        ...
        {   -logic_name => 'populate_master',
            -module     => 'Bio::EnsEMBL::Compara::RunnableDB::BuildMaster::PopulateMaster',
            -parameters => {
