...
sub default_options {
    ...
    return {
        ...
        'multifasta_dir'     => undef, # define if species multifastas have been pre-dumped. Files are expected to be directly in this directory
        'genome_dumps_dir'  => '/hps/nobackup2/production/ensembl/compara_ensembl/genome_dumps/',   # another way of configuring existing genome dumps. These ones are in sub directories that based on the genome_db_ids (generated by DumpGenomes_conf)
