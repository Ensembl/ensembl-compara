...
Specialized version of the CreateSpeciesTree pipeline for Pan. Please, refer
to the parent class for further information.

=cut

package Bio::EnsEMBL::Compara::PipeConfig::Pan::CreateSpeciesTree_conf;
...
sub default_options {
    ...
    return {
        ...
        'division'        => 'Pan',
        'taxonomic_ranks' => ['genus', 'family', 'order', 'class', 'phylum', 'kingdom', 'superkingdom', 'domain'],
        'root_taxon_id'   => '1',
        'custom_groups'   => [],
    };
}
