...
Bio::EnsEMBL::Compara::PipeConfig::Fungi::MergeDBsIntoRelease_conf

=head1 SYNOPSIS

    init_pipeline.pl Bio::EnsEMBL::Compara::PipeConfig::Fungi::MergeDBsIntoRelease_conf \
    -host mysql-ens-compara-prod-X -port XXXX

=head1 DESCRIPTION

A Fungi-specific pipeline to merge some production databases onto the release one.

The default parameters work well in the context of a Compara release for Fungi (with a well-configured
