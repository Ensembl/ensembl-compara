    ...
    return [
        ...
        {   -logic_name => 'find_lastz_patch_mlss',
            ...
            -parameters => {
                ...
                'inputquery'            => 'SELECT GROUP_CONCAT(CONCAT("--mlss ", method_link_species_set_id) SEPARATOR " ") AS mlss_ids FROM method_link_species_set JOIN method_link USING (method_link_id) JOIN species_set USING (species_set_id) JOIN genome_db USING (genome_db_id) WHERE method_link.type = "#lastz_patch_method#" AND assembly_default = 1',
            },
            -flow_into  => {
