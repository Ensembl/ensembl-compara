...
Bio::EnsEMBL::Compara::PipeConfig::ETM::PrepareMasterDatabaseForRelease_conf

=head1 SYNOPSIS

    init_pipeline.pl Bio::EnsEMBL::Compara::PipeConfig::ETM::PrepareMasterDatabaseForRelease_conf -host mysql-ens-compara-prod-X -port XXXX

=head1 DESCRIPTION

Prepare ETM master database for comparative processing.
...
package Bio::EnsEMBL::Compara::PipeConfig::ETM::PrepareMasterDatabaseForRelease_conf;
