...
Bio::EnsEMBL::Compara::RunnableDB::LastZ
...
package Bio::EnsEMBL::Compara::Production::GenomicAlignBlock::LastZ;
...
sub configure_defaults {
  ...
  $self->method_link_type('LASTZ_RAW');
