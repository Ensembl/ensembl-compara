...
Bio::EnsEMBL::Compara::RunnableDB::GenomeLoadNCMembers
...
my $g_load_members = Bio::EnsEMBL::Compara::RunnableDB::GenomeLoadNCMembers->new (
                                                    -db      => $db,
                                                    -input_id   => $input_id
                                                    -analysis   => $analysis );
...
package Bio::EnsEMBL::Compara::RunnableDB::GenomeLoadNCMembers;
