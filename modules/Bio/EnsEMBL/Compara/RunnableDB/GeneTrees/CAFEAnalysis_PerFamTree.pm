...
package Bio::EnsEMBL::Compara::RunnableDB::GeneTrees::CAFEAnalysis_PerFamTree;
...
#     unless ( $self->param('fam_tree') ) {
#         die ('fam_tree is not set');
#     }

#     unless ( $self->param('fam_table') ) {
#         die ('fam_table is not set');
#     }
    ...
    # cafe_shell, cafe_lambdas and cafe_struct_tree_str are also defined parameters
...
sub run_cafe_script {
    ...
    print $sf "load -i $cafe_table_file -p $pvalue_lim\n\n";
    print $sf "lambda -s\n";
