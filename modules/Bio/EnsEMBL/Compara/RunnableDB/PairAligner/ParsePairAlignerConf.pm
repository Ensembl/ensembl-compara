...
sub create_net_dataflows {
	...
	if ($bidirectional) {
           ...
           #
           my $ref_output_hash = {};
           %$ref_output_hash = ('method_link_species_set_id'=> $net_config->{'principal_mlss_id'} || $net_config->{'mlss_id'},
                                'is_reference' => 1,
           ...
           my $non_ref_output_hash = {};
           %$non_ref_output_hash = ('method_link_species_set_id'=> $net_config->{'principal_mlss_id'} || $net_config->{'mlss_id'},
                                    'is_reference' => 0,
