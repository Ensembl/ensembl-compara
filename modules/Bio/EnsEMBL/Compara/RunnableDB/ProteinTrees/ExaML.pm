...
sub param_defaults {
    ...
    return {
		...
		'cmd_from_scratch'     => '#parse_examl_exe# -s align.#gene_tree_id#.phylip -m #sequence_type# -n #gene_tree_id# ; sleep 10 ; /nfs/production/mpi/mpich/mpich3/3.1.1-intel/bin/mpiexec.hydra #examl_exe# -s #gene_tree_id#.binary -t gene_tree_#gene_tree_id#.nhx -m GAMMA -n #gene_tree_id# -S',
        'aln_format'           => 'phylip',
