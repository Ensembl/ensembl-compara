...
Bio::EnsEMBL::Compara::RunnableDB::ProteinTrees::FlowMemberSeq
...
my $store_seq_cds = Bio::EnsEMBL::Compara::RunnableDB::ProteinTrees::FlowMemberSeq->new
  (
   -db         => $db,
   -input_id   => $input_id,
   -analysis   => $analysis
...
package Bio::EnsEMBL::Compara::RunnableDB::ProteinTrees::FlowMemberSeq;
