...
Bio::EnsEMBL::Compara::RunnableDB::ProteinTrees::HDupsQC
...
my $dupsorthoqc = Bio::EnsEMBL::Compara::RunnableDB::ProteinTrees::HDupsQC->new
  (
   -db         => $db,
   -input_id   => $input_id,
   -analysis   => $analysis
...
package Bio::EnsEMBL::Compara::RunnableDB::ProteinTrees::HDupsQC;
