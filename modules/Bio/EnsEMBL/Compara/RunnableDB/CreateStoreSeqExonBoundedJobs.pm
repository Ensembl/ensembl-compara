...
Bio::EnsEMBL::Compara::RunnableDB::CreateStoreSeqExonBoundedJobs
...
my $analysis = $aa->fetch_by_logic_name('CreateStoreSeqExonBoundedJobs');
my $rdb = new Bio::EnsEMBL::Compara::RunnableDB::CreateStoreSeqExonBoundedJobs();
$rdb->fetch_input;
$rdb->run;
...
of arrayrefs of genome_db_ids, creates StoreSeqExonBounded jobs in the hive 
analysis_job table.
...
package Bio::EnsEMBL::Compara::RunnableDB::CreateStoreSeqExonBoundedJobs;
...
sub create_analysis_jobs {
  ...
  my $store_seq_exon_bounded_analysis = $aa->fetch_by_logic_name('StoreSeqExonBounded');
  my $analysis_id = $store_seq_exon_bounded_analysis->dbID;
