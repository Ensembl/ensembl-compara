...
=head1 DESCRIPTION
  ...
  standaloneJob.pl Bio::EnsEMBL::Compara::RunnableDB::OrthologQM::Prepare_Per_Chr_Jobs_using_preload

=cut

package Bio::EnsEMBL::Compara::RunnableDB::OrthologQM::Prepare_Per_Chr_Jobs_using_preload;
...
sub param_defaults {
  ...
  return {
    ...
    'compara_db'  => 'mysql://ensadmin:ensembl@compara4/OrthologQM_test_db_86',
