...
sub process_data {
  ...
  foreach my $go (sort keys %$data) {
    ...
    my $loc_link    = scalar @{$self->hub->species_defs->ENSEMBL_CHROMOSOMES} ? '<li><a rel="notexternal" href="'.$hub->url({type  => 'Location', action => 'Genome', ftype => 'Gene', id  => $go}).'">View on karyotype</a></li>' : "";
