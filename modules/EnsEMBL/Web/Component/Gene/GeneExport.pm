...
sub content_fasta {
  ...
  return "<pre>" . $seq_dumper->dump($self->object->get_slice_object->Obj, 'fasta', $self) . "<pre>";
}
sub content {
  my $self   = shift;
  ...
  $html .= qq{<p><a href="/@{[$object->species]}/Gene/Export/fasta?$ENV{'QUERY_STRING'};st=$_->[0]" target="_blank">$_->[1]</a></p>} for (@$links);  
