...
sub content {
 ...
 my $referer = '_referer='.$object->param('_referer').';x_requested_with='.$object->param('x_requested_with');
  ...
  $form->add_notes({'heading'=>'IMPORTANT NOTE:', 'text' => qq(<p>Data should be uploaded as a list of tab or comma separated values for more information on the expected format see <a href="/info/website/upload/index.html#Consequence">here.</a></p>) });
