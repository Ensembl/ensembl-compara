...
sub content_ajax {
  ...
  unless ($format eq 'DATAHUB' && $hub->param('assembly') ne $hub->species_defs->get_config($hub->data_species, 'ASSEMBLY_NAME')) { ## Don't give parsing message if this is a hub and we can't show it!
