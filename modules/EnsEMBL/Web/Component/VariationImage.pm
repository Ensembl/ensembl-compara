...
sub content {
  ...
  my ($count_snps, $snps, $context_count) = $gene_object->getVariationsOnSlice($transcript_slice, $sub_slices);  
  ...
  $gene_object->store_TransformedSNPS unless $no_snps;                   # Stores in $transcript_object->__data->{'transformed'}{'snps'}
