package EnsEMBL::Web::UserConfig::genesnpview_2;
use strict;
...
sub init {
  ...
  $self->{'_add_labels' }  = 1;
  $self->{'general'}->{'genesnpview_2'} = {
    '_artefacts' => [qw(ruler snp_lite intronlesstranscript geneexon_bgtrack spacer snp_join)],
