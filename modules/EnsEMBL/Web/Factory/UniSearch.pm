...
sub search_GENE {
  ...
  $self->_fetch_results( 
    ...
    [ $db, 'Gene',
      ...
      "SELECT gsi.stable_id, g.description, '$db', 'protview', 'peptide' FROM translation_stable_id as gsi, translation as g WHERE gsi.translation_id = g.translation_id and gsi.stable_id [[COMP]] '[[KEY]]'" ],
