...
sub filter_snps {
  ...
  my @filtered_snps = 
    ...
    grep { scalar map { $valids->{'opt_'. lc $_} ? 1 : () } @{$_->_list_all_consequences} } # Filter unwanted consequence classifications
...
sub filter_munged_snps {
  ...
  my @filtered_snps =
    ...
    grep { scalar map { $valids->{'opt_' . lc $_} ? 1 : () } @{$_->[2]->_list_all_consequences} } # [ fake_s, fake_e, SNP ] Filter our unwanted consequence types
