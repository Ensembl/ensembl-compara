...
sub BUILD {
  ...
  $self->add_has_many({ class => 'EnsEMBL::Web::Object::Data::Bookmark', table => 'group_record'});
  $self->add_has_many({ class => 'EnsEMBL::Web::Object::Data::Configuration', table => 'group_record'});
  $self->add_has_many({ class => 'EnsEMBL::Web::Object::Data::Annotation', table => 'group_record'});
