...
sub get_url_content {
######## DEPRECATED ################
warn "DEPRECATED METHOD 'get_url_content' - please switch to using EnsEMBL::Web::File::Utils::URL::read_file. This method will be removed in release 81.";
####################################
  my $url   = shift;
...
######## DEPRECATED ################
warn "DEPRECATED METHOD 'get_url_filesize' - please switch to using EnsEMBL::Web::File::Utils::URL::get_filesize. This method will be removed in release 81.";
####################################
