...
sub render {
  ...
  $_[0]->print( qq(
   <div id="copy"><div id="a1"><div id="a2">
    ...
    Ensembl is available to <a href="http://www.ensembl.org/info/downloads/index.html">download for public use</a> - please see the <a href="http://www.ensembl.org/info/code_licence.html">code licence</a> for details.
    </p>
    </div></div></div>
    ) 
  );
