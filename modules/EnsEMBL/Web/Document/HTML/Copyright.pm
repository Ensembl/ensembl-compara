...
sub render {
  ...
  $_[0]->print( qq(
   <div id="copy"><div id="a1"><div id="a2">
    ...
    Ensembl is available to <a href="/info/data/download.html">download for public use</a> - please see the <a href="/info/code_licence.html">code licence</a> for details.
    </p>
    </div></div></div>
    ) 
  );
