package EnsEMBL::Web::Document::HTML::Footer;
use strict;
use CGI qw(escapeHTML);
use EnsEMBL::Web::Document::HTML;
use EnsEMBL::Web::RegObj;

@EnsEMBL::Web::Document::HTML::Footer::ISA = qw(EnsEMBL::Web::Document::HTML);
...
=pod
  ...
  my @Q = ();
  my $X = 1;
  while( my $T = $sd->get_config( $ENV{'ENSEMBL_SPECIES'}, 'ENSEMBL_INSTITUTE_'.$X ) ) {
    push @Q, $T;
    $X++;
  }
