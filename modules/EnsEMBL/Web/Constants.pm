...
sub USERDATA_FORMATS {
  return {
    'bam'         => {'ext' => 'bam',     'label' => 'BAM',       'display' => 'graph',   'limit' => 'remote', 'no_karyotype' => 1},
    'bcf'         => {'ext' => 'bcf',     'label' => 'BCF',       'display' => 'graph',   'limit' => 'remote', 'no_karyotype' => 1},
    'bed'         => {'ext' => 'bed',     'label' => 'BED',       'display' => 'feature'},
    'bedgraph'    => {'ext' => 'bed',     'label' => 'bedGraph',  'display' => 'graph'},
    'bigbed'      => {'ext' => 'bb',      'label' => 'BigBed',    'display' => 'graph',   'limit' => 'remote', 'no_karyotype' => 1},
    'bigpsl'      => {'ext' => 'bb',      'label' => 'BigPsl',    'display' => 'graph',   'limit' => 'remote'},
    'bigint'      => {'ext' => 'bb',      'label' => 'BigInteract',    'display' => 'graph',   'limit' => 'remote', 'no_karyotype' => 1},
    'bigwig'      => {'ext' => 'bw',      'label' => 'BigWig',    'display' => 'graph',   'limit' => 'remote'},
    'cram'        => {'ext' => 'cram',    'label' => 'CRAM',      'display' => 'graph',   'limit' => 'remote', 'no_karyotype' => 1},
