...
sub VARIATION_OPTIONS {
  return (
    ...
    'class' =>  {
      ...
      'opt_class_somatic_in-del'        =>  [ 'on', 'Somatic in-dels' ],
      'opt_class_somatic_snv'           =>  [ 'on', 'Somatic SNVs' ],
      'opt_class_somatic_mixed'         =>  [ 'on', 'Mixed somatic mutations' ],
      'opt_class_somatic_named'         =>  [ 'on', 'Named somatic mutations' ],
      'opt_class_somatic_substitution'  =>  [ 'on', 'Somatic substitutions' ],
      'opt_class_somatic'               =>  [ 'on', 'Unclassified somatic mutations' ]
    }, 
    'type' => {
