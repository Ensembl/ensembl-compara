...
sub VARIATION_OPTIONS {
  return (
    ...
    'type' => {
      ...
      'opt_3prime_utr'              =>  [ 'on', "3' UTR", 4096 ],
      'opt_intronic'                =>  [ 'on', 'Intronic', 8192 ],
      'opt_downstream'              =>  [ 'on', 'Downstream', 65536 ],
      'opt_upstream'                =>  [ 'on', 'Upstream', 32768 ],
      ...
      'opt_sara'                    =>  [ 'on', 'SARA (same as ref.assembly)', 524288 ],
      ...
      'opt_within_non_coding_gene'  =>  [ 'on', 'Within non coding gene', 131072  ],
