...
sub cdna_position     { return $_[0]->{'__raw__'}[6];  }
sub cds_position      { return $_[0]->{'__raw__'}[7];  }
sub protein_position  { return $_[0]->{'__raw__'}[8];  }
sub aa_change         { return $_[0]->{'__raw__'}[9];  }
sub codons            { return $_[0]->{'__raw__'}[10]; }
sub snp               { return $_[0]->{'__raw__'}[11]; }
sub extra_col         { return $_[0]->{'__raw__'}[12]; }
