...
sub _init {
  ...
  my $configure_text = "The 'Configure this page' link in the menu on the left hand side of this page can be used to customise the exon context and types of variants displayed above.";
