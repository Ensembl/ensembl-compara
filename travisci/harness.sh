...
if [ "$COVERALLS" = 'true' ]; then
  ...
  PERL5OPT='-MDevel::Cover=+ignore,bioperl,+ignore,ensembl,+ignore,ensembl-test' perl $PWD/ensembl-test/scripts/runtests.pl -verbose $PWD/ensembl/modules/t/compara.t
else
  perl $PWD/ensembl-test/scripts/runtests.pl $PWD/modules/t
  perl $PWD/ensembl-test/scripts/runtests.pl $PWD/ensembl/modules/t/compara.t
fi
