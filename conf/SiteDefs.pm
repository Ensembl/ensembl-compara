...
use vars qw ( @ISA @EXPORT @EXPORT_OK %EXPORT_TAGS $VERSION
  ...
  $ENSEMBL_BASE_URL $ENSEMBL_SITE_DIR $ENSEMBL_SITE_URL $ENSEMBL_STATIC_SERVER
...
$VERSION                   = 61;
$ARCHIVE_VERSION           = "Jan2011";    # Change this to the archive site for this version
$ENSEMBL_RELEASE_DATE      = 'Jan 2011';
...
$ENSEMBL_STATIC_SERVER = $ENSEMBL_STATIC_SERVER ? "$ENSEMBL_PROTOCOL://$ENSEMBL_STATIC_SERVER" : $ENSEMBL_BASE_URL;
