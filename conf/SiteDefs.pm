...
our $ENSEMBL_VERSION        = 87;            # Ensembl release number
our $ARCHIVE_VERSION        = 'Dec2016';     # Archive site for this version
our $ENSEMBL_RELEASE_DATE   = 'Dec 2016';    # As it would appear in the copyright/footer
###############################################################################
