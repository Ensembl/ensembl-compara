...
our $ENSEMBL_VERSION        = 101;            # Ensembl release number
our $ARCHIVE_VERSION        = 'Aug2020';     # Archive site for this version
our $ENSEMBL_RELEASE_DATE   = 'August 2020'; # As it would appear in the copyright/footer
###############################################################################
