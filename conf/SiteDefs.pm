...
use vars qw ( @ISA @EXPORT @EXPORT_OK %EXPORT_TAGS $VERSION
  ...
  $ENSEMBL_ERRORS_TO
  $ENSEMBL_LOGDIR
  $ENSEMBL_USERDBFAULTFILE
  $ENSEMBL_USERDBFAULTTIMEOUT
  $ENSEMBL_PIDFILE
  $ENSEMBL_ERRORLOG
  $ENSEMBL_CUSTOMLOG
  ...
  $ENSEMBL_BASE_URL $ENSEMBL_SITE_DIR $ENSEMBL_SITE_URL $ENSEMBL_STATIC_SERVER $ENSEMBL_STATIC_SERVERNAME $ENSEMBL_STATIC_BASE_URL
...
$VERSION                   = 71;
$ARCHIVE_VERSION           = 'Apr2013';    # Change this to the archive site for this version
$ENSEMBL_RELEASE_DATE      = 'April 2013';
...
$CGI_POST_MAX           = 5242880; # 5MB max upload
...
## Set all log files into the /ensemblweb/tmp/logs/uswest/ directory
  ...
  $SiteDefs::ENSEMBL_USERDBFAULTFILE= "$log_dir/userdb-fault"; 
...
%EXPORT_TAGS = (
  ...
  APACHE => [qw(
    ...
    $ENSEMBL_ENCRYPT_2
    $ENSEMBL_ENCRYPT_3
    $ENSEMBL_ENCRYPT_EXPIRY 
    $ENSEMBL_ENCRYPT_REFRESH
    $ENSEMBL_ERRORLOG
    $ENSEMBL_GROUP
    @ENSEMBL_HTDOCS_DIRS
    $ENSEMBL_IMAGE_WIDTH
    @ENSEMBL_LIB_DIRS
    $ENSEMBL_LONGPROCESS_MINTIME
    $ENSEMBL_MAX_SPARE_SERVERS
    $ENSEMBL_MART_ENABLED
    $ENSEMBL_MIN_SPARE_SERVERS
    @ENSEMBL_PERL_DIRS
    $ENSEMBL_PIDFILE
    $ENSEMBL_USERDBFAULTFILE
    $ENSEMBL_USERDBFAULTTIMEOUT
