...
my $compara_dbs = {
    ...
    # homology dbs
    'compara_members'  => [ 'mysql-ens-compara-prod-7', 'sbhurji_pan_load_members_111_take2' ],
    'compara_ptrees'   => [ 'mysql-ens-compara-prod-7', 'sbhurji_default_pan_protein_trees_111' ],
};
