...
my $compara_dbs = {
    ...
    # homology dbs
    #'compara_members'  => [ 'mysql-ens-compara-prod-3', 'thiagogenez_pan_load_members_105' ],
    #'compara_ptrees'   => [ 'mysql-ens-compara-prod-6', 'thiagogenez_pan_pan_protein_trees_105' ],
};
