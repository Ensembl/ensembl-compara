...
my $compara_dbs = {
    ...
    'compara_nctrees'         => [ 'mysql-ens-compara-prod-7',  'twalsh_default_vertebrates_ncrna_trees_take2_116' ],
    'murinae_ptrees'          => [ 'mysql-ens-compara-prod-8',  'twalsh_murinae_vertebrates_protein_trees_116' ],
    'murinae_nctrees'         => [ 'mysql-ens-compara-prod-8',  'twalsh_vertebrates_murinae_ncrna_reindexed_trees_116' ],
    'murinae_ptrees_prev'     => [  'mysql-ens-compara-prod-1',  'sbhurji_vertebrates_murinae_protein_reindexed_trees_115'],
    'murinae_nctrees_prev'    => [ 'mysql-ens-compara-prod-6',  'sbhurji_vertebrates_murinae_ncrna_reindexed_trees_115' ],
    'pig_breeds_ptrees'       => [ 'mysql-ens-compara-prod-9',  'twalsh_pig_breeds_vertebrates_protein_trees_116' ],
    'pig_breeds_nctrees'      => [ 'mysql-ens-compara-prod-9', 'twalsh_pig_breeds_vertebrates_ncrna_trees_116' ],
    'pig_breeds_ptrees_prev'  => [ 'mysql-ens-compara-prod-1',  'sbhurji_pig_breeds_vertebrates_protein_trees_115' ],
    'pig_breeds_nctrees_prev' => [ 'mysql-ens-compara-prod-4',  'twalsh_pig_breeds_vertebrates_ncrna_trees_take3_115' ],

    # LASTZ dbs
    'lastz_batch_1'    => [ 'mysql-ens-compara-prod-7', 'twalsh_vertebrates_lastz_batch1_116' ],
    ...
    'mammals_epo_prev'     => [ 'mysql-ens-compara-prod-4', 'sbhurji_mammals_epo_with_ext_115' ],
    ...
    ## pig strains
    'pig_breeds_epo_w_ext'     => [ 'mysql-ens-compara-prod-7', 'twalsh_pig_breeds_epo_with_ext_take2_116' ],
    ...
    ## murinae
    'murinae_epo'          => [ 'mysql-ens-compara-prod-9', 'sbhurji_murinae_epo_115' ],
    'murinae_epo_prev'     => [ 'mysql-ens-compara-prod-9', 'sbhurji_murinae_epo_115' ],
...
my $ancestral_dbs = {
    ...
    #'ancestral_curr' => [ 'mysql-ens-compara-prod-9', "ensembl_ancestral_$curr_release" ],
    ...
    'murinae_ancestral'    => [ 'mysql-ens-compara-prod-9', 'sbhurji_murinae_ancestral_core_115' ],
};
