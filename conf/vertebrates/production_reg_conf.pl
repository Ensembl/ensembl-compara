...
my $compara_dbs = {
    ...
    'murinae_ptrees'        => [ 'mysql-ens-compara-prod-8', 'jalvarez_vertebrates_murinae_protein_reindexed_trees_100' ],
    'murinae_nctrees'       => [ 'mysql-ens-compara-prod-8', 'jalvarez_vertebrates_murinae_ncrna_reindexed_trees_100' ],
