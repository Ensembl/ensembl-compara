...
class TestAlignmentsToParitions:
    ...
    def test_merge_output(self, tmp_dir: Path) -> None:
        ...
        input_file = str(Path(__file__).parents[0] /
                         'flatfiles' / 'SpeciesTreeFromBusco' / 'busco_merge_input_fofn.txt')
        input_taxa = str(Path(__file__).parents[0] /
                         'flatfiles' / 'SpeciesTreeFromBusco' / 'collate_output_taxa.tsv')
        ...
        expected_fasta = str(Path(__file__).parents[0] / "flatfiles" / "SpeciesTreeFromBusco"
                             / "busco_merged.fas")
